...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void Initialize(DetectedPlane plane)
        {
            ...
            addPlants(m_DetectedPlane);

            Update();
        }

        private void addPlants(DetectedPlane plane)
        {
            GameObject plant = Instantiate(plantPrefab, new Vector3(Random.Range(0, plane.ExtentX), 0, Random.Range(0, plane.ExtentZ)), plantPrefab.transform.rotation);
