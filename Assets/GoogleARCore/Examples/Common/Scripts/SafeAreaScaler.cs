...
namespace GoogleARCore.Examples.Common
{
    ...
    /// <summary>
    /// A helper component that scale the UI rect to the same size as the safe area (which defines the UI which is visible to the user although the screen may not be a rectangle). 
    /// </summary>
